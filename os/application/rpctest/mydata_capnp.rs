...
pub mod my_data {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_c(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_c(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_c(&mut self, value: ::capnp::text::Reader)  {
      self.builder.get_pointer_field(0).set_text(value);
    }
    #[inline]
    pub fn init_c(self, size: u32) -> ::capnp::text::Builder<'a> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xd02c_b1d9_2b48_728a;
  }
}
